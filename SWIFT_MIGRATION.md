...
- [ ] **階段 2：改寫字元編碼對照表 (Encoding Tables)**
  ...
  - [ ] 建立 `YLEncodingTable.swift` 實作非同步/延遲載入並讀取上述 binary table。
  - [ ] 自專案中移除 [encoding.h](file:///Users/ericsk/Projects/Nally-Unofficial/Code/encoding.h) 與 [encoding.m](file:///Users/ericsk/Projects/Nally-Unofficial/Code/encoding.m)。
...
- [ ] **階段 4：測試模組與編譯清理**
  - [ ] 將單元測試 [TextSuiteTests.m](file:///Users/ericsk/Projects/Nally-Unofficial/Tests/TextSuiteTests.m) 與 [TextSuiteTests.h](file:///Users/ericsk/Projects/Nally-Unofficial/Tests/TextSuiteTests.h) 重寫為 Swift 版本的 `TextSuiteTests.swift`。
